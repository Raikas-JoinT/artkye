class Affiliate < ApplicationRecord
  ...
  def self.affiliate_sites(params)
    ...
    items = results.items
    items.map { |item| { title: item.title, link: item.link, published_time: item.pagemap['metatags'].map { |published_time| published_time['article:published_time'] }, modified_time: item.pagemap['metatags'].map { |modified_time| modified_time['article:modified_time'] } } }
  end
